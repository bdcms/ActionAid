...
<head>
  ...
  <title>Dashboard - Actionaid Zambia</title>
  ...
  <link rel="stylesheet" href="{{asset('public/admin/dist/css/customize_css.css')}}">
...
<div class="wrapper">
  ...
  <header class="main-header action_brand">
    <!-- Logo -->
    <a href="index2.html" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <img src="images/akaunting-logo-white.png" alt="images"  >
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Acdms</b></span>
    </a>
