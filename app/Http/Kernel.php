...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'AuthenticateCheck' => \App\Http\Middleware\checkAuth::class,

        //access area defiend
        'onlyAdmin'     => \App\Http\Middleware\onlyAdmin::class,
        'onlyCountry'   => \App\Http\Middleware\onlyCountry::class,
        ...
        'onlyProgram'   => \App\Http\Middleware\onlyProgram::class,
        'onlyProject'   => \App\Http\Middleware\onlyProject::class, 
    ];
}
